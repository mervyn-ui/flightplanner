...
def travel_guide():
    ...
    AIRPORT_COORDS = {
        ...
        "BES": (48.447800, -4.418600), "BVA": (49.454400,  2.112800),
        "BIQ": (43.468300, -1.523200), "RNS": (48.069700, -1.734800),
        "TLN": (43.097300,  6.146000), "CFE": (45.786800,  3.169200),
        "LIG": (45.862800,  1.179400), "AJA": (41.923600,  8.802900),
        "BIA": (42.552700,  9.483700), "FSC": (41.500600,  9.097800),
        # UK
        ...
        "EXT": (50.734400, -3.413900), "EMA": (52.831200, -1.328100),
        "CWL": (51.396700, -3.343300), "PIK": (55.509400, -4.586700),
        "NQY": (50.440600, -4.995100), "INV": (57.542500, -4.047500),
        # Ireland
        ...
        "REU": (41.147400,  1.167200), "ZAZ": (41.666300, -1.041500),
        "VIT": (42.882800, -2.724500), "EAS": (43.356500, -1.790600),
        "XRY": (36.744600, -6.060100), "GRX": (37.188700, -3.777400),
        "LEI": (36.843900, -2.370100), "RMU": (37.803000, -1.125300),
        "MAH": (39.862600,  4.218600), "CDT": (40.213600,  0.073100),
        "LCG": (43.302100, -8.377600),
        ...
        "ACE": (28.945500,-13.605200), "SPC": (28.626500,-17.755600),
        "VDE": (27.814900,-17.887100), "GMZ": (28.029600,-17.214600),
        # Italy
        ...
        "FLR": (43.810000, 11.205100), "TRS": (45.827500, 13.472200),
        "AOI": (43.616100, 13.362200), "BDS": (40.657600, 17.947000),
        "SUF": (38.905400, 16.242300), "CAG": (39.251500,  9.054300),
        "OLB": (40.898700,  9.517600), "AHO": (40.632100,  8.290800),
        ...
        "TSR": (45.799900, 21.337900), "IAS": (47.178600, 27.620600),
        "SOF": (42.696700, 23.411400), "VAR": (43.232100, 27.825100),
        "BOJ": (42.569600, 27.515200),
        # Balkans
        ...
        "CHQ": (35.531700, 24.149700), "ZTH": (37.750900, 20.884300),
        "PVK": (38.925400, 20.765300), "JSI": (39.177200, 23.503700),
        "LCA": (34.875100, 33.624900),
        ...
        # Germany (additional)
        "BRE": (53.047500,  8.786700), "FMO": (52.134600,  7.684800),
        "FMM": (47.988800, 10.239500), "PAD": (51.614100,  8.616300),
        "ERF": (50.979800, 10.958100), "RLG": (53.918200, 12.278300),
        "FDH": (47.671300,  9.511500),
        # France (additional)
        "MPL": (43.576200,  3.963000), "GNB": (45.362900,  5.329400),
        "CMF": (45.638100,  5.880200), "ETZ": (48.982100,  6.251300),
        "LRH": (46.179200, -1.195300), "PUF": (43.380000, -0.418600),
        "PGF": (42.740400,  2.870700), "EGC": (44.825300,  0.518600),
        "LRT": (47.760600, -3.440000), "DNR": (48.587800, -2.079900),
        # UK (additional)
        "BOH": (50.780000, -1.842500), "NWI": (52.675800,  1.282800),
        "IOM": (54.083300, -4.623900), "JER": (49.207900, -2.195500),
        "GCI": (49.435000, -2.600300),
        # Italy (additional)
        "GOA": (44.413300,  8.837500), "RMI": (44.020400, 12.611700),
        "PSR": (42.431700, 14.181100), "PMF": (44.824500, 10.296400),
        "PEG": (43.099100, 12.513200), "REG": (38.071200, 15.651600),
        "CIY": (36.994600, 14.607300), "QSR": (40.620400, 14.911300),
        # Norway (additional)
        "BOO": (67.269200, 14.365300), "AES": (62.562500,  6.119700),
        "KRS": (58.204200,  8.085400), "EVE": (68.491300, 16.678100),
        "LYR": (78.246100, 15.465600), "MOL": (62.744700,  7.262500),
        "KSU": (63.111800,  7.824500),
        # Sweden (additional)
        "NYO": (58.788600, 16.912200), "UME": (63.791800, 20.282800),
        "LLA": (65.543800, 22.122200), "KRN": (67.822000, 20.336800),
        "OSD": (63.194400, 14.500300), "SDL": (62.528100, 17.443900),
        "SFT": (64.624800, 21.076900), "VST": (59.589400, 16.633600),
        # Denmark (additional)
        "AAR": (56.300000, 10.619000), "FAE": (62.063600, -7.277200),
        # Finland (additional)
        "TKU": (60.514100, 22.262800), "RVN": (66.564800, 25.830400),
        "KTT": (67.701000, 24.846800), "VAA": (63.050700, 21.762200),
        "JYV": (62.399500, 25.678300), "KUO": (63.007100, 27.797800),
        "IVL": (68.607300, 27.405300),
        # Poland (additional)
        "WMI": (52.451100, 20.651800), "RZE": (50.110000, 22.019000),
        "SZZ": (53.584700, 14.902200), "LCJ": (51.721900, 19.398100),
        "BZG": (53.096800, 17.977700), "LUZ": (51.240300, 22.713600),
        # Czech Republic / Slovakia (additional)
        "OSR": (49.696300, 18.111100), "KSC": (48.663200, 21.241100),
        # Romania (additional)
        "SBZ": (45.785600, 24.091300), "BAC": (46.521900, 26.910300),
        "CND": (44.362200, 28.488300), "OMR": (47.025200, 21.902500),
        "ARW": (46.176600, 21.262000), "SUJ": (47.703300, 22.885700),
        # Hungary (additional)
        "DEB": (47.488900, 21.615300),
        # Croatia (additional)
        "ZAD": (44.108300, 15.346700), "PUY": (44.893500, 13.922200),
        "RJK": (45.216900, 14.570300), "OSI": (45.462700, 18.810200),
        # Serbia / Balkans (additional)
        "INI": (43.337300, 21.853800), "TIV": (42.404700, 18.723300),
        # Lithuania (additional)
        "KUN": (54.963900, 24.084800), "PLQ": (55.973300, 21.093900),
        # Greece (additional)
        "EFL": (38.120100, 20.500500), "SMI": (37.690000, 26.911700),
        "MJT": (39.056700, 26.598300), "KVA": (40.913300, 24.619200),
        "HEV": (40.855900, 25.956300), "AOK": (35.421400, 27.146000),
        "IOA": (39.696400, 20.822500),
        # Turkey (additional)
        "DLM": (36.713100, 28.792500), "BJV": (37.250500, 27.664300),
        "ESB": (40.128100, 32.995100),
        # Morocco (additional)
        "FEZ": (33.927300, -4.977900), "TNG": (35.726900, -5.916900),
        "NDR": (34.988800, -3.028200), "OUD": (34.787200, -1.924000),
        # Tunisia (additional)
        "DJE": (33.875000, 10.775500), "MIR": (35.758100, 10.754700),
    }
    ...
    AIRPORT_NAMES = {
        ...
        "BES": "Brest",             "BVA": "Paris Beauvais",
        "BIQ": "Biarritz",          "RNS": "Rennes",
        "TLN": "Toulon-Hyères",     "CFE": "Clermont-Ferrand",
        "LIG": "Limoges",           "AJA": "Ajaccio",
        "BIA": "Bastia",            "FSC": "Figari",
        ...
        "EXT": "Exeter",               "EMA": "East Midlands",
        "CWL": "Cardiff",              "PIK": "Glasgow Prestwick",
        "NQY": "Newquay Cornwall",     "INV": "Inverness",
        "DUB": "Dublin",               "ORK": "Cork",
        "SNN": "Shannon",
        ...
        "REU": "Reus",                 "ZAZ": "Zaragoza",
        "VIT": "Vitoria-Gasteiz",      "EAS": "San Sebastián",
        "XRY": "Jerez",                "GRX": "Granada",
        "LEI": "Almería",              "RMU": "Murcia International",
        "MAH": "Menorca",              "CDT": "Castellón",
        "LCG": "A Coruña",
        "LPA": "Gran Canaria",         "TFS": "Tenerife South",
        "TFN": "Tenerife North",       "FUE": "Fuerteventura",
        "ACE": "Lanzarote",            "SPC": "La Palma",
        "VDE": "El Hierro",            "GMZ": "La Gomera",
        ...
        "FLR": "Florence",             "TRS": "Trieste",
        "AOI": "Ancona",               "BDS": "Brindisi",
        "SUF": "Lamezia Terme",        "CAG": "Cagliari",
        "OLB": "Olbia",                "AHO": "Alghero",
        "BRI": "Bari",                 "VRN": "Verona",
        ...
        "TSR": "Timișoara",            "IAS": "Iași",
        "SOF": "Sofia",                "VAR": "Varna",
        "BOJ": "Burgas",                "BEG": "Belgrade",
        ...
        "CHQ": "Chania",               "ZTH": "Zakynthos",
        "PVK": "Preveza",              "JSI": "Skiathos",
        "LCA": "Larnaca",
        ...
        "BRE": "Bremen",               "FMO": "Münster Osnabrück",
        "FMM": "Memmingen",            "PAD": "Paderborn",
        "ERF": "Erfurt",               "RLG": "Rostock",
        "FDH": "Friedrichshafen",
        "MPL": "Montpellier",          "GNB": "Grenoble",
        "CMF": "Chambéry",             "ETZ": "Metz-Nancy",
        "LRH": "La Rochelle",          "PUF": "Pau",
        "PGF": "Perpignan",            "EGC": "Bergerac",
        "LRT": "Lorient",              "DNR": "Dinard",
        "BOH": "Bournemouth",          "NWI": "Norwich",
        "IOM": "Isle of Man",          "JER": "Jersey",
        "GCI": "Guernsey",
        "GOA": "Genoa",                "RMI": "Rimini",
        "PSR": "Pescara",              "PMF": "Parma",
        "PEG": "Perugia",              "REG": "Reggio Calabria",
        "CIY": "Comiso",               "QSR": "Salerno",
        "BOO": "Bodø",                 "AES": "Ålesund",
        "KRS": "Kristiansand",         "EVE": "Harstad/Narvik",
        "LYR": "Svalbard",             "MOL": "Molde",
        "KSU": "Kristiansund",
        "NYO": "Stockholm Skavsta",    "UME": "Umeå",
        "LLA": "Luleå",                "KRN": "Kiruna",
        "OSD": "Östersund",            "SDL": "Sundsvall",
        "SFT": "Skellefteå",           "VST": "Stockholm Västerås",
        "AAR": "Aarhus",               "FAE": "Faroe Islands",
        "TKU": "Turku",                "RVN": "Rovaniemi",
        "KTT": "Kittilä",              "VAA": "Vaasa",
        "JYV": "Jyväskylä",            "KUO": "Kuopio",
        "IVL": "Ivalo",
        "WMI": "Warsaw Modlin",        "RZE": "Rzeszów",
        "SZZ": "Szczecin",             "LCJ": "Łódź",
        "BZG": "Bydgoszcz",            "LUZ": "Lublin",
        "OSR": "Ostrava",              "KSC": "Košice",
        "SBZ": "Sibiu",                "BAC": "Bacău",
        "CND": "Constanța",            "OMR": "Oradea",
        "ARW": "Arad",                 "SUJ": "Satu Mare",
        "DEB": "Debrecen",
        "ZAD": "Zadar",                "PUY": "Pula",
        "RJK": "Rijeka",               "OSI": "Osijek",
        "INI": "Niš",                  "TIV": "Tivat",
        "KUN": "Kaunas",               "PLQ": "Palanga",
        "EFL": "Kefalonia",            "SMI": "Samos",
        "MJT": "Mytilene",             "KVA": "Kavala",
        "HEV": "Alexandroupolis",      "AOK": "Karpathos",
        "IOA": "Ioannina",
        "DLM": "Dalaman",              "BJV": "Bodrum",
        "ESB": "Ankara",
        "FEZ": "Fez",                  "TNG": "Tangier",
        "NDR": "Nador",                "OUD": "Oujda",
        "DJE": "Djerba",               "MIR": "Monastir",
    }
    ...
    AIRPORT_TZ = {
        ...
        **{k: "Europe/Paris"     for k in ["CDG","ORY","NCE","MRS","LYS","BOD","TLS","NTE","SXB","LIL","BES","BVA","BIQ","RNS","TLN","CFE","LIG","AJA","BIA","FSC"]},
        **{k: "Europe/London"    for k in ["LHR","LGW","STN","MAN","LTN","BHX","EDI","GLA","BRS","NCL","LPL","LBA","ABZ","BFS","BHD","SOU","EXT","EMA","CWL","PIK","NQY","INV"]},
        **{k: "Europe/Dublin"    for k in ["DUB","ORK","SNN"]},
        **{k: "Europe/Lisbon"    for k in ["OPO","LIS","FAO","PDL","FNC"]},
        **{k: "Atlantic/Canary"  for k in ["LPA","TFS","TFN","FUE","ACE","SPC","VDE","GMZ"]},
        **{k: "Europe/Madrid"    for k in ["MAD","BCN","AGP","VLC","SVQ","BIO","SDR","OVD","SCQ","VGO","PMI","IBZ","ALC","GRO","REU","ZAZ","VIT","EAS","XRY","GRX","LEI","RMU","MAH","CDT","LCG"]},
        **{k: "Europe/Rome"      for k in ["FCO","CIA","MXP","LIN","BGY","VCE","TSF","NAP","CTA","PMO","BRI","VRN","BLQ","PSA","FLR","TRS","AOI","BDS","SUF","CAG","OLB","AHO"]},
        **{k: "Europe/Oslo"      for k in ["OSL","BGO","SVG","TRD","TOS"]},
        ...
        **{k: "Europe/Bucharest" for k in ["OTP","CLJ","TSR","IAS"]},
        **{k: "Europe/Sofia"     for k in ["SOF","VAR","BOJ"]},
        ...
        **{k: "Europe/Athens"    for k in ["ATH","SKG","HER","RHO","CFU","KGS","JMK","JTR","CHQ","ZTH","PVK","JSI"]},
        ...
        **{k: "Africa/Casablanca" for k in ["CMN","RAK","AGA","FEZ","TNG","NDR","OUD"]},
        **{k: "Africa/Tunis"     for k in ["TUN","DJE","MIR"]},
        **{k: "Europe/Berlin"    for k in ["BRE","FMO","FMM","PAD","ERF","RLG","FDH"]},
        **{k: "Europe/Paris"     for k in ["MPL","GNB","CMF","ETZ","LRH","PUF","PGF","EGC","LRT","DNR"]},
        **{k: "Europe/London"    for k in ["BOH","NWI","IOM","JER","GCI"]},
        **{k: "Europe/Rome"      for k in ["GOA","RMI","PSR","PMF","PEG","REG","CIY","QSR"]},
        **{k: "Europe/Oslo"      for k in ["BOO","AES","KRS","EVE","LYR","MOL","KSU"]},
        **{k: "Europe/Stockholm" for k in ["NYO","UME","LLA","KRN","OSD","SDL","SFT","VST"]},
        **{k: "Europe/Copenhagen" for k in ["AAR","FAE"]},
        **{k: "Europe/Helsinki"  for k in ["TKU","RVN","KTT","VAA","JYV","KUO","IVL"]},
        **{k: "Europe/Warsaw"    for k in ["WMI","RZE","SZZ","LCJ","BZG","LUZ"]},
        **{k: "Europe/Prague"    for k in ["OSR"]},
        **{k: "Europe/Bratislava" for k in ["KSC"]},
        **{k: "Europe/Bucharest" for k in ["SBZ","BAC","CND","OMR","ARW","SUJ"]},
        **{k: "Europe/Budapest"  for k in ["DEB"]},
        **{k: "Europe/Zagreb"    for k in ["ZAD","PUY","RJK","OSI"]},
        **{k: "Europe/Belgrade"  for k in ["INI"]},
        **{k: "Europe/Podgorica" for k in ["TIV"]},
        **{k: "Europe/Vilnius"   for k in ["KUN","PLQ"]},
        **{k: "Europe/Athens"    for k in ["EFL","SMI","MJT","KVA","HEV","AOK","IOA"]},
        **{k: "Europe/Istanbul"  for k in ["DLM","BJV","ESB"]},
    }
